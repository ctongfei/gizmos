...
class DepthFirstIterator[S](val stateSpace: StateSpaceWithEq[S], start: S) extends Searcher[S, S](
...
class BreadthFirstIterator[S](val stateSpace: StateSpaceWithEq[S], start: S) extends Searcher[S, S](
...
class DepthFirstBacktrackableIterator[S](val stateSpace: StateSpaceWithEq[S], start: S) extends Searcher[S, WithParent[S]](
...
class BreadthFirstBacktrackableIterator[S](val stateSpace: StateSpaceWithEq[S], start: S) extends Searcher[S, WithParent[S]](
